                ...
                <form method="POST" action="{{ route('host.places.update', $place) }}" enctype="multipart/form-data" name="edit-form">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="address" name="address"
                            value="{{ old('title', $place->address) }}" required>
                        {{-- Error --}}
                        @error('address')
                            <div class="alert alert-danger">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="rooms" name="rooms"
                            value="{{ old('rooms', $place->rooms) }}" required>
                        {{-- Error --}}
                        @error('rooms')
                            <div class="alert alert-danger">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="beds" name="beds"
                            value="{{ old('beds', $place->beds) }}" required>
                        {{-- Error --}}
                        @error('beds')
                            <div class="alert alert-danger">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="bathrooms" name="bathrooms"
                            value="{{ old('bathrooms', $place->bathrooms) }}" required>
                        {{-- Error --}}
                        @error('bathrooms')
                            <div class="alert alert-danger">
                                {{ $message }}
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="square_meters" name="square_meters"
                            value="{{ old('square_meters', $place->square_meters) }}" required>
                        {{-- Error --}}
                        @error('square_meters')
                            <div class="alert alert-danger">
                                {{ $message }}
